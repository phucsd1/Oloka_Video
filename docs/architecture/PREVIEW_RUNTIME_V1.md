...
The compatibility fixture is self-contained and network-denial tested. Full Composition V1/v7 materialization remains a later, separately authorized Phase 3F implementation.
